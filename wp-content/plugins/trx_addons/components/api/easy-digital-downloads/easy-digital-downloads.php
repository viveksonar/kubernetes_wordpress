...
if ( !function_exists( 'trx_addons_edd_ocdi_set_options' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_options', 'trx_addons_edd_ocdi_set_options' );
...
// Export Easy Digital Downloads
if ( !function_exists( 'trx_addons_edd_ocdi_export' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_export_files', 'trx_addons_edd_ocdi_export' );
...
if ( !function_exists( 'trx_addons_edd_ocdi_import_field' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_import_fields', 'trx_addons_edd_ocdi_import_field' );
...
// Import Easy Digital Downloads
if ( !function_exists( 'trx_addons_edd_ocdi_import' ) ) {	
	if (is_admin()) add_action( 'trx_addons_action_ocdi_import_plugins', 'trx_addons_edd_ocdi_import', 10, 1 );
...
if ( !function_exists( 'trx_addons_edd_ocdi_post_meta' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_process_post_meta', 'trx_addons_edd_ocdi_post_meta', 10, 2 );
