...
class trx_addons_widget_edd_search extends TRX_Addons_Widget {
	...
	function form($instance) {
		...
		do_action('trx_addons_action_before_widget_fields', $instance, 'trx_addons_widget_edd_search');
		...
		do_action('trx_addons_action_after_widget_title', $instance, 'trx_addons_widget_edd_search');
		...
		do_action('trx_addons_action_after_widget_fields', $instance, 'trx_addons_widget_edd_search');
	}
}
...
//-------------------------------------------------------------
/*
[trx_widget_edd_search id="unique_id" title="Widget title" orderby="price" order="desc"]
*/
if ( !function_exists( 'trx_addons_sc_widget_edd_search' ) ) {
	function trx_addons_sc_widget_edd_search($atts, $content=null){	
		$atts = trx_addons_sc_prepare_atts('trx_widget_edd_search', $atts, array(
			// Individual params
			"title" => "",
			"orderby" => "date",
			"order" => "desc",
...
// Add [trx_widget_edd_search] in the VC shortcodes list
