...
if (!function_exists('trx_addons_tourmaster_sc_add_in_vc')) {
	function trx_addons_tourmaster_sc_add_in_vc() {
		...
		if (!trx_addons_exists_vc() || !trx_addons_exists_tourmaster()) return;
...
if ( !function_exists( 'trx_addons_ocdi_tourmaster_set_options' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_options', 'trx_addons_ocdi_tourmaster_set_options' );
...
if ( !function_exists( 'trx_addons_ocdi_tourmaster_export' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_export_files', 'trx_addons_ocdi_tourmaster_export' );
...
if ( !function_exists( 'trx_addons_ocdi_tourmaster_import_field' ) ) {
	if (is_admin()) add_filter( 'trx_addons_filter_ocdi_import_fields', 'trx_addons_ocdi_tourmaster_import_field' );
...
if ( !function_exists( 'trx_addons_ocdi_tourmaster_import' ) ) {
	if (is_admin()) add_action( 'trx_addons_action_ocdi_import_plugins', 'trx_addons_ocdi_tourmaster_import', 10, 1 );
