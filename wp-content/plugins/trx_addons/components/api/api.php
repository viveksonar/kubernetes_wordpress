...
if ( !function_exists( 'trx_addons_exists_vc' ) ) {
	function trx_addons_exists_vc() {
		return class_exists('Vc_Manager') && trx_addons_components_is_allowed('api', 'js_composer') ;
	}
}
...
if ( !function_exists( 'trx_addons_exists_page_builder' ) ) {
	function trx_addons_exists_page_builder() {
		return trx_addons_exists_vc() || trx_addons_exists_elementor() || trx_addons_exists_sop() || trx_addons_exists_gutenberg();
	}
}
