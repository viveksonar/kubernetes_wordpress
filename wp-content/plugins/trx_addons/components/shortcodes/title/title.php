...
if (!function_exists('trx_addons_sc_title_gutenberg_editor_assets')) {
	//UC: add_action( 'enqueue_block_editor_assets', 'trx_addons_sc_title_gutenberg_editor_assets' );
	function trx_addons_sc_title_gutenberg_editor_assets() {
		wp_enqueue_script(
			'trx_addons-gutenberg-editor-block-title',
			trx_addons_get_file_url( TRX_ADDONS_PLUGIN_SHORTCODES . 'title/gutenberg/dist/bundle.js' ),
...
if (!function_exists('trx_addons_sc_title_add_in_gutenberg')) {
	//UC: add_action( 'init', 'trx_addons_sc_title_add_in_gutenberg' );
	function trx_addons_sc_title_add_in_gutenberg() {
		if (!trx_addons_exists_gutenberg()) return;	
		register_block_type( 'trx_addons/title', array(
		) );
	}
}
