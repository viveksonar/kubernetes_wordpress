		...
		<div class="columns_wrap columns_fluid">
			<div class="sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid column-1_4">
				...
				<div class="sc_layouts_item">
					<?php
					// Main menu
					$shift_cv_menu_main = shift_cv_get_nav_menu(
						array(
							'location' => 'menu_main',
					...
					if ( shift_cv_get_theme_setting( 'autoselect_menu' ) && empty( $shift_cv_menu_main ) ) {
						$shift_cv_menu_main = shift_cv_get_nav_menu(
							array(
								'class' => 'sc_layouts_menu sc_layouts_menu_default sc_layouts_hide_on_mobile',
							)
					...
					shift_cv_show_layout( $shift_cv_menu_main );
					// Mobile menu button
					?>
				...
				if ( shift_cv_exists_trx_addons() ) {
					...
					<div class="sc_layouts_item">
						...
						do_action( 'shift_cv_action_search', 'fullscreen', 'header_search', false );
						?>
					</div>
					<?php
				}
